  ...
  return (
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        ...
        <a style={{marginLeft:5}} href='https://twitter.com/atticgismw1'><TwitterIcon /></a>
        <a style={{marginLeft:5}} href="https://github.com/GISSIAH/blackout-check"><GitHubIcon /></a>
        <a style={{marginLeft:5}} href="https://linkedin.com/company/atticgismw"><LinkedIn/></a>
      </footer>
    </div>
  )
}
